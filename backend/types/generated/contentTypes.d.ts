...
export interface ApiHealthHealth extends Schema.CollectionType {
  ...
  attributes: {
    nameofplace: Attribute.String & Attribute.Required;
    address: Attribute.String & Attribute.Required;
    contactnumber: Attribute.BigInteger & Attribute.Required & Attribute.Unique;
    openhours: Attribute.String;
...
export interface ApiPetfriendlyPetfriendly extends Schema.CollectionType {
  collectionName: 'petfriendlies';
  info: {
    singularName: 'petfriendly';
    pluralName: 'petfriendlies';
    displayName: 'Petfriendly';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiSpeciesSpecies extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    breed: Attribute.String & Attribute.Required & Attribute.Unique;
...
export interface ApiWellnessWellness extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::petfriendly.petfriendly': ApiPetfriendlyPetfriendly;
